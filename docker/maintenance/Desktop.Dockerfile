...
COPY tools/approval_context.py tools/process_registry.py tools/bot_mode_dm.py /opt/hermes/tools/
COPY tui_gateway/methods_prompt.py /opt/hermes/tui_gateway/
